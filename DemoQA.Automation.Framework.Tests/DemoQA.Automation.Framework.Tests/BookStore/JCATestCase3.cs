...
{
    public class JCATestCase3 : AutomationTestBase
    {
        private JCABookStoreApplicationWrapper jcaBookStoreApplicationWrapper;
        public JCATestCase3(AutomationFixture fixture, ITestOutputHelper output) : base(fixture, output)
        {
        ...
        public void VerifyTestCase3Implementation(string aUserName, string aPassword, string aBook1, string aBook2, string aBook3, string aBook4, string aBook5, string aBook6, string aBook7)
        {
            ...
            jcaBookStoreApplicationWrapper.SearchBox.SendKeys("You Don't Know JS");
