// <copyright file="JCABookStoreApplicationWrapper.cs" company="PlaceholderCompany">
...
namespace DemoQA.Automation.Framework.Wrappers.BookStore
{
    ...
    /// <summary>
    /// Locator for all screens in Book Store applications.
    /// </summary>
    public class JCABookStoreApplicationWrapper
    {
